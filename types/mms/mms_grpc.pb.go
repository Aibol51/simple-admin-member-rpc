...
const (
	...
	Mms_GetMemberByPhoneNumber_FullMethodName = "/mms.Mms/getMemberByPhoneNumber"
...
func (c *mmsClient) GetMemberByPhoneNumber(ctx context.Context, in *PhoneNumberReq, opts ...grpc.CallOption) (*MemberInfo, error) {
	out := new(MemberInfo)
	err := c.cc.Invoke(ctx, Mms_GetMemberByPhoneNumber_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MmsServer interface {
	...
	// group: member
	GetMemberByPhoneNumber(context.Context, *PhoneNumberReq) (*MemberInfo, error)
	// MemberRank management
	// group: memberrank
...
func (UnimplementedMmsServer) GetMemberByPhoneNumber(context.Context, *PhoneNumberReq) (*MemberInfo, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetMemberByPhoneNumber not implemented")
}
...
func _Mms_GetMemberByPhoneNumber_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PhoneNumberReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MmsServer).GetMemberByPhoneNumber(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Mms_GetMemberByPhoneNumber_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MmsServer).GetMemberByPhoneNumber(ctx, req.(*PhoneNumberReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Mms_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "getMemberByPhoneNumber",
			Handler:    _Mms_GetMemberByPhoneNumber_Handler,
		},
		{
